...
sys.path.append('..')
from utils.analysis_utils import get_vn_versus_mass, compute_resolution
...
def check_anres(config, an_res_file, outputdir, suffix, do_ep):
    ...
    if meson == 'Dplus':
        ...
        #[1.74, 1.75, 1.76, 1.77, 1.78, 1.79, 1.80, 1.81, 1.82, 1.83, 1.835, 1.84, 1.845, 1.85, 1.855, 1.86, 1.865, 1.87, 1.875, 1.88, 1.885, 1.89, 1.895, 1.90, 1.905, 1.91, 1.915, 1.92, 1.925, 1.93, 1.935, 1.94, 1.945, 1.95, 1.955, 1.96, 1.965, 1.97, 1.975, 1.98, 1.985, 1.99, 1.995, 2.00]
    elif meson == 'Ds':
